...
namespace CarInsurance.Controllers
{
    public class InsureeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,EmailAddress,DateOfBirth,CarYear,CarMake,CarModel,DUI,SpeedingTickets,CoverageType,Quote")] Insuree insuree)
        {
            ...
            if (currentYear - insuree.DateOfBirth.Year < 18) quote += 50;
            if (currentYear - insuree.DateOfBirth.Year < 25) quote += 50;
            else if (currentYear - insuree.DateOfBirth.Year > 24) quote += 25;
            ...
            if (insuree.CoverageType == true) quote += quote * .5M;
